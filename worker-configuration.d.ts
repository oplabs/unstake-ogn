/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c9f11ebe64df81eeb1ec578f0072bb82)
// Runtime types generated with workerd@1.20250823.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		VITE_ALCHEMY_ID: string;
		VITE_ALCHEMY_RPC: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_ALCHEMY_ID" | "VITE_ALCHEMY_RPC">> {}
}
